...
target_classes = {'plastic bottle', 'paper', 'can'}
        ...
        for box, confidence, class_id in zip(boxes, confidences, class_ids):
            ...
            if label:
                ...
                if box_key not in unique_objects:
                    ...
                    #label_text = f"{label}: {confidence:.5f}"
        ...
        for box, confidence, class_id in filtered_boxes:
            ...
            if label in target_classes:
                ...
                if new_object:
                    ...
                    cv2.rectangle(frame, (x_min, y_min), (x_max, y_max), (128, 0, 128), 2)
                    label_text = f"{label}: {confidence:.2f}"
                    cv2.putText(frame, label_text, (x_min, y_min - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (128, 0, 128), 2)
